// This showcases the basic one shot MCMC functions implemented in integration.hpp by using them 
// to simulate the MALA and HMC functions to model the anharmonic oscillator. The more robust 
// and advanced showcase is in anharmonic_pimc.cpp which uses the full suite in mcmc/
